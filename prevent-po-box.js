  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (continueButton) {
      continueButton.addEventListener('click', function(event) {
        var country = document.body.getAttribute('data-checkout-country');
        ...
        if (country !== "US") {
          // Implement your custom checks for non-US addresses here
        } else if ((addressField1 && /(P\.?\s?O\.?|PO|Box)\s?\d+/i.test(addressField1.value)) || 
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (continueButton) {
      continueButton.addEventListener('click', function(event) {
        ...
        if (country !== "US") {
          // Implement your custom checks for non-US addresses here
        } else if ((addressField3 && poBoxRegex2.test(addressField3.value)) || 
